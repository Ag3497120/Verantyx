...
public:
	...
	* exceed the length of the supplied buffer should be truncated and null terminated */
	...
	virtual DriverPose_t* GetPose(DriverPose_t* ret) = 0;
#else
...
namespace vr
{
	...
	public:
		...
		* the upper left of that eye's viewport and 1,1 in the lower right of that eye's viewport. */
		virtual DistortionCoordinates_t* ComputeDistortion( DistortionCoordinates_t* pRet, EVREye eEye, float fU, float fV ) = 0;
