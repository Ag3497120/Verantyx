...
class VerantyxApp(toga.App):
    ...
    def startup(self):
        ...
        self.sidebar_content.add(toga.Button("＋ New Chat", on_press=self.start_new_chat, style=Pack(margin_bottom=20, background_color="#238636", color="#000000")))
        ...
        self.knowledge_panel.add(self.kp_title); self.knowledge_panel.add(self.knowledge_rows_container)
        self.knowledge_panel.add(toga.Button("Retry with Context", on_press=self.do_retry_all, style=Pack(margin_top=10, background_color="#238636", color="white")))

        self.update_theme_ui(); self.apply_native_styling(); self.update_history_ui()
        ...
        except Exception as e: print(f"[Native Error] {e}")
            
        asyncio.create_task(self.load_engine(self))
    ...
    def apply_native_styling(self):
        if hasattr(self.main_window, "_impl") and hasattr(self.main_window._impl, "native"):
            try:
                ...
                if hasattr(self, "knowledge_panel") and hasattr(self.knowledge_panel, "_impl") and hasattr(self.knowledge_panel._impl, "native"):
    ...
    def update_history_ui(self):
        ...
        for sid, info in sorted_sessions:
            ...
            btn = toga.Button(
                ...
                style=Pack(background_color="transparent", color="#000000", flex=1)
            )
    ...
    def update_theme_ui(self):
        ...
        if hasattr(self, 'knowledge_panel'): self.knowledge_panel.style.background_color = "#00DFFF"
