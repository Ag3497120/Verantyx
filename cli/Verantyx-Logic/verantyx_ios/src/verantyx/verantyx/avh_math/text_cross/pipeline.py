...
def text_decomposition_pipeline(text: str):
    ...
    from .bridge import extract_formula_hint_from_cross, extract_formula_hint_from_similars, extract_formula_hint
...
def run_text_decomposition_pipeline(
    ...
    *,
    ...
    from .builder import build_text_cross
    from .store import store_cross
    from .cross_kb_query import query_similar_cross_kb_scored, extract_hint_from_cross
