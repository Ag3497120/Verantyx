...
DEST = Path("verantyx_ios/src/verantyx")
...
# 2. Copy toga-core (the main namespace)
...
# 3. Merge toga-iOS content (critical for namespace packages)
...
print("Toga Namespace Merged Successfully!")
